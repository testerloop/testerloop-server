...
import {
    ...
    StepEventModel,
    StepEventEdgeModel,
    StepEventConnectionModel,
    ScenarioEventModel,
    TestExecutionModel,
    TestExecutionConnectionModel,
    TestExecutionEdgeModel,
    TestExecutionEventConnectionModel,
    TestExecutionEventEdgeModel,
    TestRunModel,
    TestRunConnectionModel,
    TestRunEdgeModel,
    GitHubRevisionModel,
    CommandChainEventModel,
    CommandChainEventEdgeModel,
    CommandChainEventConnectionModel,
    CommandEventModel,
    CommandEventEdgeModel,
    CommandEventConnectionModel,
    TestExecutionSnapshotModel,
    TestExecutionScreenshotModel,
    GitHubRevisionFileModel,
    GitHubRevisionFileLineModel,
    GitHubRevisionFileLineColumnModel,
    SourceCodeManagementRevisionFileLineColumnModel,
} from './mappers';
...
export type CommandChainEvent = Event &
    IntervalEvent &
    TestExecutionEvent & {
...
export type ConsoleLogEvent = ConsoleEvent &
    Event &
    InstantaneousEvent &
    Node &
    TestExecutionEvent & {
...
export type GitHubRevision = GitRevision &
    SourceCodeManagementRevision & {
...
export type GitHubRevisionFile = GitRevisionFile &
    SourceCodeManagementRevisionFile & {
        readonly __typename: 'GitHubRevisionFile';
        readonly path: Scalars['String'];
        readonly revision: GitHubRevision;
    };

export type GitHubRevisionFileLine = GitRevisionFileLine &
    SourceCodeManagementRevisionFileLine & {
...
export type GitHubRevisionFileLineColumn = GitRevisionFileLineColumn &
    SourceCodeManagementRevisionFileLineColumn & {
...
export type HttpNetworkEvent = Event &
    IntervalEvent &
    NetworkEvent &
    TestExecutionEvent & {
...
export type HttpResponseBodyChunk = Event &
    InstantaneousEvent & {
...
export type NetworkEventFilterInput = {
    readonly resourceType?: InputMaybe<
        ReadonlyArray<HttpNetworkEventResourceType>
    >;
...
export type NetworkEventTiming = Event &
    IntervalEvent & {
...
export type ScenarioEvent = Event &
    IntervalEvent &
    TestExecutionEvent & {
...
export type TestExecution = Event &
    IntervalEvent &
    Node & {
...
export type TestExecutionScreenshot = Event &
    InstantaneousEvent &
    Node &
    TestExecutionEvent & {
...
export type TestExecutionSnapshot = Event &
    InstantaneousEvent &
    TestExecutionEvent & {
...
export type ResolversTypes = {
    ...
    CommandEventError: ResolverTypeWrapper<
        Omit<CommandEventError, 'location'> & {
            location: ResolversTypes['SourceCodeManagementRevisionFileLineColumn'];
        }
    >;
    ...
    Event:
        | ResolversTypes['CommandChainEvent']
        | ResolversTypes['CommandEvent']
        | ResolversTypes['ConsoleLogEvent']
        | ResolversTypes['HttpNetworkEvent']
        | ResolversTypes['HttpResponseBodyChunk']
        | ResolversTypes['NetworkEventTiming']
        | ResolversTypes['ScenarioEvent']
        | ResolversTypes['StepEvent']
        | ResolversTypes['TestExecution']
        | ResolversTypes['TestExecutionScreenshot']
        | ResolversTypes['TestExecutionSnapshot'];
    ...
    HttpBody:
        | ResolversTypes['HttpRequestBody']
        | ResolversTypes['HttpResponseBody'];
    ...
    TestExecutionEnvironment: ResolverTypeWrapper<
        Omit<TestExecutionEnvironment, 'browser'> & {
            browser: ResolversTypes['BrowserVersion'];
        }
    >;
    TestExecutionEvent:
        | ResolversTypes['CommandChainEvent']
...
export type ResolversParentTypes = {
    ...
    CommandEventError: Omit<CommandEventError, 'location'> & {
        location: ResolversParentTypes['SourceCodeManagementRevisionFileLineColumn'];
    };
    CommandEventFilterInput: CommandEventFilterInput;
    ...
    Event:
        | ResolversParentTypes['CommandChainEvent']
        | ResolversParentTypes['CommandEvent']
        | ResolversParentTypes['ConsoleLogEvent']
        | ResolversParentTypes['HttpNetworkEvent']
        | ResolversParentTypes['HttpResponseBodyChunk']
        | ResolversParentTypes['NetworkEventTiming']
        | ResolversParentTypes['ScenarioEvent']
        | ResolversParentTypes['StepEvent']
        | ResolversParentTypes['TestExecution']
        | ResolversParentTypes['TestExecutionScreenshot']
        | ResolversParentTypes['TestExecutionSnapshot'];
    Field: Field;
    ...
    HttpBody:
        | ResolversParentTypes['HttpRequestBody']
        | ResolversParentTypes['HttpResponseBody'];
    HttpHeaderOrderInput: HttpHeaderOrderInput;
    ...
    TestExecutionEnvironment: Omit<TestExecutionEnvironment, 'browser'> & {
        browser: ResolversParentTypes['BrowserVersion'];
    };
    TestExecutionEvent:
        | ResolversParentTypes['CommandChainEvent']
        | ResolversParentTypes['CommandEvent']
...
export type BrowserVersionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['BrowserVersion'] = ResolversParentTypes['BrowserVersion']
> = {
    __resolveType: TypeResolveFn<'ChromiumVersion', ParentType, ContextType>;
};

export type CallFrameResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CallFrame'] = ResolversParentTypes['CallFrame']
> = {
...
export type ChromiumVersionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['ChromiumVersion'] = ResolversParentTypes['ChromiumVersion']
> = {
...
export type CommandChainEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandChainEvent'] = ResolversParentTypes['CommandChainEvent']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    commands: Resolver<
        ResolversTypes['CommandEventConnection'],
        ParentType,
        ContextType
    >;
    testExecution: Resolver<
        ResolversTypes['TestExecution'],
        ParentType,
        ContextType
    >;
...
export type CommandChainEventConnectionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandChainEventConnection'] = ResolversParentTypes['CommandChainEventConnection']
> = {
    edges: Resolver<
        ReadonlyArray<ResolversTypes['CommandChainEventEdge']>,
        ParentType,
        ContextType
    >;
...
export type CommandChainEventEdgeResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandChainEventEdge'] = ResolversParentTypes['CommandChainEventEdge']
> = {
...
export type CommandEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandEvent'] = ResolversParentTypes['CommandEvent']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    description: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    error: Resolver<
        Maybe<ResolversTypes['CommandEventError']>,
        ParentType,
        ContextType
    >;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    nextSnapshot: Resolver<
        Maybe<ResolversTypes['TestExecutionSnapshot']>,
        ParentType,
        ContextType
    >;
    ...
    >;
    status: Resolver<
        ResolversTypes['CommandEventStatus'],
        ParentType,
        ContextType
    >;
    testExecution: Resolver<
...
export type CommandEventConnectionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandEventConnection'] = ResolversParentTypes['CommandEventConnection']
> = {
    edges: Resolver<
        ReadonlyArray<ResolversTypes['CommandEventEdge']>,
        ParentType,
        ContextType
    >;
    pageInfo: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
...
export type CommandEventEdgeResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandEventEdge'] = ResolversParentTypes['CommandEventEdge']
> = {
    cursor: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>;
...
export type CommandEventErrorResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['CommandEventError'] = ResolversParentTypes['CommandEventError']
> = {
    location: Resolver<
        ResolversTypes['SourceCodeManagementRevisionFileLineColumn'],
        ParentType,
        ContextType
    >;
...
export type ConsoleEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['ConsoleEvent'] = ResolversParentTypes['ConsoleEvent']
> = {
    __resolveType: TypeResolveFn<'ConsoleLogEvent', ParentType, ContextType>;
};

export type ConsoleLogEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['ConsoleLogEvent'] = ResolversParentTypes['ConsoleLogEvent']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    logLevel: Resolver<
        ResolversTypes['ConsoleLogLevel'],
        ParentType,
        ContextType
    >;
    message: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type CookieResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['Cookie'] = ResolversParentTypes['Cookie']
> = {
...
export type GitBranchResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitBranch'] = ResolversParentTypes['GitBranch']
> = {
    __resolveType: TypeResolveFn<'GitHubBranch', ParentType, ContextType>;
};

export type GitHubActorResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubActor'] = ResolversParentTypes['GitHubActor']
> = {
...
export type GitHubOrganizationResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubOrganization'] = ResolversParentTypes['GitHubOrganization']
> = {
    name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type GitHubRepositoryResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubRepository'] = ResolversParentTypes['GitHubRepository']
> = {
    _unused: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
    name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    owner: Resolver<
        ResolversTypes['GitHubRepositoryOwner'],
        ParentType,
        ContextType
    >;
    url: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
...
export type GitHubRepositoryOwnerResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubRepositoryOwner'] = ResolversParentTypes['GitHubRepositoryOwner']
> = {
    name: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    url: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GitHubRevisionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubRevision'] = ResolversParentTypes['GitHubRevision']
> = {
    author: Resolver<ResolversTypes['GitHubActor'], ParentType, ContextType>;
    branch: Resolver<
        Maybe<ResolversTypes['GitHubBranch']>,
        ParentType,
        ContextType
    >;
    commitId: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<GitHubRevisionCommitIdArgs, 'type'>
    >;
    committer: Resolver<ResolversTypes['GitHubActor'], ParentType, ContextType>;
    repository: Resolver<
        ResolversTypes['GitHubRepository'],
        ParentType,
        ContextType
    >;
    url: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
...
export type GitHubRevisionFileResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubRevisionFile'] = ResolversParentTypes['GitHubRevisionFile']
> = {
    path: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    revision: Resolver<
        ResolversTypes['GitHubRevision'],
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GitHubRevisionFileLineResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubRevisionFileLine'] = ResolversParentTypes['GitHubRevisionFileLine']
> = {
    file: Resolver<
        ResolversTypes['GitHubRevisionFile'],
        ParentType,
        ContextType
    >;
...
export type GitHubRevisionFileLineColumnResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitHubRevisionFileLineColumn'] = ResolversParentTypes['GitHubRevisionFileLineColumn']
> = {
    column: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    line: Resolver<
        ResolversTypes['GitHubRevisionFileLine'],
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GitRevisionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitRevision'] = ResolversParentTypes['GitRevision']
> = {
    __resolveType: TypeResolveFn<'GitHubRevision', ParentType, ContextType>;
};

export type GitRevisionFileResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitRevisionFile'] = ResolversParentTypes['GitRevisionFile']
> = {
    __resolveType: TypeResolveFn<'GitHubRevisionFile', ParentType, ContextType>;
};

export type GitRevisionFileLineResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitRevisionFileLine'] = ResolversParentTypes['GitRevisionFileLine']
> = {
    __resolveType: TypeResolveFn<
...
export type GitRevisionFileLineColumnResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['GitRevisionFileLineColumn'] = ResolversParentTypes['GitRevisionFileLineColumn']
> = {
    __resolveType: TypeResolveFn<
...
export type HttpBodyResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpBody'] = ResolversParentTypes['HttpBody']
> = {
    __resolveType: TypeResolveFn<
...
export type HttpHeadersResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpHeaders'] = ResolversParentTypes['HttpHeaders']
> = {
    size: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    values: Resolver<
        ReadonlyArray<ResolversTypes['KeyValuePair']>,
        ParentType,
        ContextType,
        RequireFields<HttpHeadersValuesArgs, 'order'>
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type HttpNetworkEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpNetworkEvent'] = ResolversParentTypes['HttpNetworkEvent']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    initiator: Resolver<
        ResolversTypes['HttpNetworkEventInitiator'],
        ParentType,
        ContextType
    >;
    request: Resolver<
        ResolversTypes['HttpNetworkRequest'],
        ParentType,
        ContextType
    >;
    ...
    >;
    response: Resolver<
        ResolversTypes['HttpNetworkResponse'],
        ParentType,
        ContextType
    >;
    testExecution: Resolver<
    ...
    >;
    timings: Resolver<
        ResolversTypes['HttpNetworkTimings'],
        ParentType,
        ContextType
    >;
    until: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type HttpNetworkEventInitiatorResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpNetworkEventInitiator'] = ResolversParentTypes['HttpNetworkEventInitiator']
> = {
...
export type HttpNetworkRequestResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpNetworkRequest'] = ResolversParentTypes['HttpNetworkRequest']
> = {
    body: Resolver<
        Maybe<ResolversTypes['HttpRequestBody']>,
        ParentType,
        ContextType
    >;
    cookies: Resolver<
        ReadonlyArray<Maybe<ResolversTypes['Cookie']>>,
        ParentType,
        ContextType
    >;
    ...
    >;
    url: Resolver<
        ResolversTypes['HttpNetworkRequestUrl'],
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type HttpNetworkRequestUrlResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpNetworkRequestUrl'] = ResolversParentTypes['HttpNetworkRequestUrl']
> = {
    nonKeyValueQueryString: Resolver<
        Maybe<ResolversTypes['String']>,
        ParentType,
        ContextType
    >;
...
export type HttpNetworkResponseResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpNetworkResponse'] = ResolversParentTypes['HttpNetworkResponse']
> = {
    body: Resolver<ResolversTypes['HttpResponseBody'], ParentType, ContextType>;
    cookies: Resolver<
        ReadonlyArray<ResolversTypes['Cookie']>,
        ParentType,
        ContextType
    >;
    headers: Resolver<ResolversTypes['HttpHeaders'], ParentType, ContextType>;
...
export type HttpNetworkTimingsResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpNetworkTimings'] = ResolversParentTypes['HttpNetworkTimings']
> = {
    blocked: Resolver<
        ResolversTypes['NetworkEventTiming'],
        ParentType,
...
export type HttpRequestBodyResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpRequestBody'] = ResolversParentTypes['HttpRequestBody']
> = {
...
export type HttpResponseBodyResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpResponseBody'] = ResolversParentTypes['HttpResponseBody']
> = {
    chunks: Resolver<
        ReadonlyArray<ResolversTypes['HttpResponseBodyChunk']>,
        ParentType,
        ContextType
    >;
    data: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type HttpResponseBodyChunkResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['HttpResponseBodyChunk'] = ResolversParentTypes['HttpResponseBodyChunk']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    data: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    size: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type InstantaneousEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['InstantaneousEvent'] = ResolversParentTypes['InstantaneousEvent']
> = {
    __resolveType: TypeResolveFn<
        | 'ConsoleLogEvent'
        | 'HttpResponseBodyChunk'
...
export type IntervalEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['IntervalEvent'] = ResolversParentTypes['IntervalEvent']
> = {
    __resolveType: TypeResolveFn<
        | 'CommandChainEvent'
        | 'CommandEvent'
...
> = {
    createTestRun: Resolver<
        Maybe<ResolversTypes['UploadInfo']>,
        ParentType,
        ContextType,
        RequireFields<MutationCreateTestRunArgs, 'runEnvironmentDetails'>
    >;
};

export type NetworkEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['NetworkEvent'] = ResolversParentTypes['NetworkEvent']
> = {
    __resolveType: TypeResolveFn<'HttpNetworkEvent', ParentType, ContextType>;
};

export type NetworkEventTimingResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['NetworkEventTiming'] = ResolversParentTypes['NetworkEventTiming']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    until: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = {
    consoleLogEvent: Resolver<
        Maybe<ResolversTypes['ConsoleLogEvent']>,
        ParentType,
        ContextType,
        RequireFields<QueryConsoleLogEventArgs, 'id'>
    >;
    httpNetworkEvent: Resolver<
        Maybe<ResolversTypes['HttpNetworkEvent']>,
        ParentType,
        ContextType,
        RequireFields<QueryHttpNetworkEventArgs, 'id'>
    >;
    node: Resolver<
    ...
    >;
    testExecution: Resolver<
        Maybe<ResolversTypes['TestExecution']>,
        ParentType,
        ContextType,
        RequireFields<QueryTestExecutionArgs, 'id'>
    >;
    testRun: Resolver<
        Maybe<ResolversTypes['TestRun']>,
        ParentType,
        ContextType,
        RequireFields<QueryTestRunArgs, 'id'>
    >;
    testRuns: Resolver<
        ResolversTypes['TestRunConnection'],
        ParentType,
        ContextType,
        Partial<QueryTestRunsArgs>
    >;
};

export type ScenarioDefinitionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['ScenarioDefinition'] = ResolversParentTypes['ScenarioDefinition']
> = {
    description: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ScenarioEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['ScenarioEvent'] = ResolversParentTypes['ScenarioEvent']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    definition: Resolver<
        ResolversTypes['ScenarioDefinition'],
        ParentType,
        ContextType
    >;
    steps: Resolver<
        ResolversTypes['StepEventConnection'],
        ParentType,
        ContextType
    >;
    testExecution: Resolver<
...
export type SnapshotEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SnapshotEvent'] = ResolversParentTypes['SnapshotEvent']
> = {
    __resolveType: TypeResolveFn<
        'CommandEvent' | 'StepEvent',
        ParentType,
        ContextType
    >;
};

export type SourceCodeManagementRepositoryResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SourceCodeManagementRepository'] = ResolversParentTypes['SourceCodeManagementRepository']
> = {
    __resolveType: TypeResolveFn<'GitHubRepository', ParentType, ContextType>;
};

export type SourceCodeManagementRevisionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SourceCodeManagementRevision'] = ResolversParentTypes['SourceCodeManagementRevision']
> = {
    __resolveType: TypeResolveFn<'GitHubRevision', ParentType, ContextType>;
};

export type SourceCodeManagementRevisionFileResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SourceCodeManagementRevisionFile'] = ResolversParentTypes['SourceCodeManagementRevisionFile']
> = {
    __resolveType: TypeResolveFn<'GitHubRevisionFile', ParentType, ContextType>;
};

export type SourceCodeManagementRevisionFileLineResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SourceCodeManagementRevisionFileLine'] = ResolversParentTypes['SourceCodeManagementRevisionFileLine']
> = {
    __resolveType: TypeResolveFn<
        'GitHubRevisionFileLine',
        ParentType,
...
export type SourceCodeManagementRevisionFileLineColumnResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['SourceCodeManagementRevisionFileLineColumn'] = ResolversParentTypes['SourceCodeManagementRevisionFileLineColumn']
> = {
    __resolveType: TypeResolveFn<
        'GitHubRevisionFileLineColumn',
        ParentType,
...
export type StackTraceResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['StackTrace'] = ResolversParentTypes['StackTrace']
> = {
    callFrames: Resolver<
        ReadonlyArray<ResolversTypes['CallFrame']>,
        ParentType,
        ContextType
    >;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type StepDefinitionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['StepDefinition'] = ResolversParentTypes['StepDefinition']
> = {
    description: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    keyword: Resolver<
        ResolversTypes['GherkinStepKeyword'],
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type StepEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['StepEvent'] = ResolversParentTypes['StepEvent']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    commandChains: Resolver<
        ResolversTypes['CommandChainEventConnection'],
        ParentType,
        ContextType
    >;
    definition: Resolver<
        ResolversTypes['StepDefinition'],
        ParentType,
        ContextType
    >;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type StepEventConnectionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['StepEventConnection'] = ResolversParentTypes['StepEventConnection']
> = {
    edges: Resolver<
        ReadonlyArray<ResolversTypes['StepEventEdge']>,
        ParentType,
        ContextType
    >;
    pageInfo: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
...
export type StepEventEdgeResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['StepEventEdge'] = ResolversParentTypes['StepEventEdge']
> = {
    cursor: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>;
...
export type TestCreationResponseResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestCreationResponse'] = ResolversParentTypes['TestCreationResponse']
> = {
    testID: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TestExecutionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecution'] = ResolversParentTypes['TestExecution']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    environment: Resolver<
        ResolversTypes['TestExecutionEnvironment'],
        ParentType,
        ContextType
    >;
    events: Resolver<
        ResolversTypes['TestExecutionEventConnection'],
        ParentType,
        ContextType,
        Partial<TestExecutionEventsArgs>
    >;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type TestExecutionConnectionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionConnection'] = ResolversParentTypes['TestExecutionConnection']
> = {
    edges: Resolver<
        ReadonlyArray<ResolversTypes['TestExecutionEdge']>,
        ParentType,
        ContextType
    >;
    pageInfo: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
...
export type TestExecutionEdgeResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionEdge'] = ResolversParentTypes['TestExecutionEdge']
> = {
    cursor: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>;
...
export type TestExecutionEnvironmentResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionEnvironment'] = ResolversParentTypes['TestExecutionEnvironment']
> = {
    browser: Resolver<
        ResolversTypes['BrowserVersion'],
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type TestExecutionEventResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionEvent'] = ResolversParentTypes['TestExecutionEvent']
> = {
    __resolveType: TypeResolveFn<
        | 'CommandChainEvent'
        | 'CommandEvent'
...
export type TestExecutionEventConnectionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionEventConnection'] = ResolversParentTypes['TestExecutionEventConnection']
> = {
    edges: Resolver<
        ReadonlyArray<ResolversTypes['TestExecutionEventEdge']>,
        ParentType,
        ContextType
    >;
    pageInfo: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
...
export type TestExecutionEventEdgeResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionEventEdge'] = ResolversParentTypes['TestExecutionEventEdge']
> = {
    cursor: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>;
    node: Resolver<
        ResolversTypes['TestExecutionEvent'],
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type TestExecutionScreenshotResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionScreenshot'] = ResolversParentTypes['TestExecutionScreenshot']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    testExecution: Resolver<
...
export type TestExecutionSnapshotResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestExecutionSnapshot'] = ResolversParentTypes['TestExecutionSnapshot']
> = {
    at: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type TestRunResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestRun'] = ResolversParentTypes['TestRun']
> = {
    executions: Resolver<
        ResolversTypes['TestExecutionConnection'],
        ParentType,
        ContextType,
        Partial<TestRunExecutionsArgs>
    >;
    id: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    testCodeRevision: Resolver<
        Maybe<ResolversTypes['SourceCodeManagementRevision']>,
        ParentType,
        ContextType
    >;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type TestRunConnectionResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestRunConnection'] = ResolversParentTypes['TestRunConnection']
> = {
    edges: Resolver<
        ReadonlyArray<ResolversTypes['TestRunEdge']>,
        ParentType,
        ContextType
    >;
    pageInfo: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
...
export type TestRunEdgeResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['TestRunEdge'] = ResolversParentTypes['TestRunEdge']
> = {
    cursor: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>;
...
export type UploadInfoResolvers<
    ContextType = Context,
    ParentType extends ResolversParentTypes['UploadInfo'] = ResolversParentTypes['UploadInfo']
> = {
    fields: Resolver<
        Maybe<ReadonlyArray<Maybe<ResolversTypes['Field']>>>,
        ParentType,
        ContextType
    >;
