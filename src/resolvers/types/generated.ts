...
export type Subscription = {
  ...
  readonly testExecutionUpdated: TestExecutionStatus;
};
...
export type SubscriptionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = {
  testExecutionUpdated: SubscriptionResolver<ResolversTypes['TestExecutionStatus'], "testExecutionUpdated", ParentType, ContextType, RequireFields<SubscriptionTestExecutionUpdatedArgs, 'id'>>;
};
